...
sleep 2
sudo docker run -d --net ss --ip 172.20.0.10 --add-host  catalogue:172.20.0.4 --add-host  orders:172.20.0.9   --add-host  user:172.20.0.7 --add-host  carts:172.20.0.8 --add-host  payment:172.20.0.6 --add-host  shipping:172.20.0.5  -p 1234:8079 dplsming/sockshop-frontend:0.1
sleep 2
sudo docker run -d --net ss --ip 172.20.0.11 -v /home/shenruien/Desktop/handson3/handson3/conf.d:/etc/nginx/conf.d  -v  /home/shenruien/Desktop/handson3/handson3/frontend/public:/usr/public -p 12345:12345 nginx:latest
