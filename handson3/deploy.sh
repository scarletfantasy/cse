...
sleep 2
sudo docker run -d --net ss --ip 172.20.0.10 --add-host session-db:172.20.0.13 --add-host  catalogue:172.20.0.4 --add-host  orders:172.20.0.9   --add-host  user:172.20.0.7 --add-host  carts:172.20.0.8 --add-host  payment:172.20.0.6 --add-host  shipping:172.20.0.5  -e SESSION_REDIS=1 dplsming/sockshop-frontend:0.1
sleep 2
sudo docker run -d --net ss --ip 172.20.0.11 --add-host session-db:172.20.0.13 --add-host  catalogue:172.20.0.4 --add-host  orders:172.20.0.9   --add-host  user:172.20.0.7 --add-host  carts:172.20.0.8 --add-host  payment:172.20.0.6 --add-host  shipping:172.20.0.5  -e SESSION_REDIS=1 dplsming/sockshop-frontend:0.1
sleep 2
sudo docker run -d --net ss --ip 172.20.0.12 --add-host session-db:172.20.0.13 --add-host  catalogue:172.20.0.4 --add-host  orders:172.20.0.9   --add-host  user:172.20.0.7 --add-host  carts:172.20.0.8 --add-host  payment:172.20.0.6 --add-host  shipping:172.20.0.5  -e SESSION_REDIS=1 dplsming/sockshop-frontend:0.1
sleep 2
sudo docker run -d --net ss --ip 172.20.0.13 redis:latest
sleep 2
